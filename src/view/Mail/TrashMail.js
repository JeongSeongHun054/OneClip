...
import { trashMailRemove } from "../../modules/trashMailModules";
...
const TrashMail = () => {
  const data = useSelector((state) => state.trashMailModules.datas);
  const dispatch = useDispatch();
  const onRemove = useCallback((id) => dispatch(trashMailRemove(id)), [
    dispatch,
  ]);
  return (
    <Wrapper>
