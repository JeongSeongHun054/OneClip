...
import { tempMailRemove } from "../../modules/tempMailModules";
...
const TempMail = () => {
  const data = useSelector((state) => state.tempMailModules.datas);
  const dispatch = useDispatch();
  const onRemove = useCallback((id) => dispatch(tempMailRemove(id)), [
    dispatch,
  ]);
  return (
    <Wrapper>
