...
import { importantMailRemove } from "../../modules/importantMailModules";
...
const ImportantMail = () => {
  const data = useSelector((state) => state.importantMailModules.datas);
  const dispatch = useDispatch();
  const onRemove = useCallback((id) => dispatch(importantMailRemove(id)), [
    dispatch,
  ]);
  return (
    <Wrapper>
