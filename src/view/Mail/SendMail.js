...
import { sendMailRemove } from "../../modules/sendMailModules";
...
const SendMail = () => {
  const data = useSelector((state) => state.sendMailModules.datas);
  const dispatch = useDispatch();
  const onRemove = useCallback((id) => dispatch(sendMailRemove(id)), [
    dispatch,
  ]);
  return (
    <Wrapper>
