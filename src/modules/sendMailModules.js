...
const SEND_MAIL_REMOVE = "sendMail/REMOVE";

export const sendMailRemove = createAction(SEND_MAIL_REMOVE, (id) => id);
...
const sendMailModules = handleActions(
  {
    [SEND_MAIL_REMOVE]: (state, action) => ({
      ...state,
...
export default sendMailModules;
