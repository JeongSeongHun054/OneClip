...
const TEMP_MAIL_REMOVE = "tempMail/REMOVE";

export const tempMailRemove = createAction(TEMP_MAIL_REMOVE, (id) => id);
...
const tempMailModules = handleActions(
  {
    [TEMP_MAIL_REMOVE]: (state, action) => ({
      ...state,
...
export default tempMailModules;
