...
const IMPORTANT_MAIL_REMOVE = "importantMail/REMOVE";

export const importantMailRemove = createAction(
  IMPORTANT_MAIL_REMOVE,
  (id) => id
);
...
const importantMailModules = handleActions(
  {
    [IMPORTANT_MAIL_REMOVE]: (state, action) => ({
      ...state,
...
export default importantMailModules;
