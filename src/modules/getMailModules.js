...
const GET_MAIL_REMOVE = "getMail/REMOVE";

export const getMailRemove = createAction(GET_MAIL_REMOVE, (id) => id);
...
const getMailModules = handleActions(
  {
    [GET_MAIL_REMOVE]: (state, action) => ({
      ...state,
